...
%\vec command will be mathbf instead of arrows above.
\renewcommand{\vec}[1]{\mathbf{#1}}

\usepackage{enumitem}
\usepackage{siunitx}

% Fixes an issue escaped underscore in bib file prints as %5c in bibliography - source: http://tex.stackexchange.com/questions/169784/biblatex-escaped-underscore-in-bib-file-prints-as-5c-in-bibliography
\DeclareSourcemap{
...
% Euler scripted font for scripted X and Y used for inertial coordinate system
\usepackage[mathscr]{euscript}

% Increase vertical space between lines in align
%\setlength{\jot}{0.4cm}
...
% Makes it easy to write ordinary- and partial differential quotients
\usepackage{commath}

% DOES NOT WORK!!! >:(
% In equation reference range, make en-dash instead of the word "to":
\newcommand{\crefrangeconjunction}{--}
\crefname{equation}{equation}{equations}
%source: http://tex.stackexchange.com/questions/18986/is-there-a-standard-way-to-refer-to-a-range-of-equations
%source: http://www.latex-community.org/forum/viewtopic.php?f=5&t=7113

% Import whole PDFs at a time (used for Mathematica Data appendix)
\usepackage{pdfpages}

% Set width of quotes at the beginning of chapters 
\setlength{\epigraphwidth}{0.8\textwidth}

% Extra units to SI-units
\DeclareSIUnit{\days}{days}
% Make default per-mode symbol, i.e. {km\per\s} becomes km/s, and make fractions small when per-mode=fraction is set manually.
\sisetup{
  per-mode=symbol,
  fraction-function=\tfrac
}
% unit ranges use "--" instead of "to"
\sisetup{range-phrase=-}

% loaded for the sole purpose of getting rid of a few annoying warnings when using gensym, see http://tex.stackexchange.com/questions/165115/getting-not-defining-perthousnad-and-not-defining-micro-when-compiling-beamer
\usepackage{textcomp}
% gensymb = generic symbols in math, needed for \degree command
\usepackage{gensymb}
