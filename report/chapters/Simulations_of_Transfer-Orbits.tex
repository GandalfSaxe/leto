...
\begin{enumerate}
    ...
    \item One refinement-run on the best trajectory as initial guess, with allv values set to 1/10 their previous value, and making 55 variations of all three parameters.
\end{enumerate}
